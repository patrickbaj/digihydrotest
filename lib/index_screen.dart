  ...
  Future<void> signIn() async {
    try {
      ...
      await FirebaseDatabase.instance
          .ref('FailedAttempts/$currentUserID')
          .set({'attempts': 0, 'timestamp': DateTime.now().millisecondsSinceEpoch});
      checkAlert();
      errorMessage = '';
      ...
      if (error.code == 'user-not-found') {
        ...
        final ref = FirebaseDatabase.instance.ref('FailedAttempts/$currentUserID');
        ...
        if (snapshot.exists) {
              ...
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content: Text('Too many failed attempts, please try again in 1 hour or tap on "Reset Password"'),
                    actions: <Widget>[
                      TextButton(
                        child: Text('OK'),
                        onPressed: () {
          ...
          await ref.set({'attempts': 1, 'timestamp': DateTime.now().millisecondsSinceEpoch});
        }
      } else {
